  ...
  return (
    <div className="relative group h-full">
      ...
      <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl h-full flex flex-col">
        ...
        <div className={`bg-gradient-to-r ${gradient} p-0.5 rounded-t-2xl`}>
        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          <div className="mb-6 flex-1">
            <h4 className="text-sm font-semibold text-gray-300 mb-3 uppercase tracking-wider">Answer</h4>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <p className="text-gray-200 leading-relaxed text-lg">{result.answer}</p>
            </div>
          </div>
          ...
          <div className="border-t border-white/10 pt-6">
            <button
              ...
              aria-label={`${showContext ? "Hide" : "Show"} context sources`}
            >
              <div className="flex items-center">
                <FileText className="h-5 w-5 mr-2" />
                <span className="font-semibold">Retrieved Context ({result.context.length} chunks)</span>
              </div>
              <div className={`transform transition-transform duration-200 ${showContext ? "rotate-180" : ""}`}>
